<template>
    <div class="outside-div">
      <img src="C:\Users\user\Desktop\VueJS\network-login\src\assets\HKT_logo.png" class="icon">
      <h3 class="ib text-title py-2">Network checking</h3>
      <button @click="changeLanguage" class="ib button ms-2">Change Language</button>
    </div>
  ...
  <script>
  import Dropdown from "C:\\Users\\user\\Desktop\\VueJS\\network-login\\src\\components\\Dropdown.vue"
