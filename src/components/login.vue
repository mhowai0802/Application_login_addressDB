<template>
  ...
  <div class="align" id="body">
    <div class="grid">
      ...
      >
        <div class="form__field">
          <label for="login__username">
            ...
            <span class="hidden">Username@pccw.com</span>
          </label>
          <input
            type="text"
            name="username"
            placeholder="Username@pccw.com"
            id="username"
            class="form-control"
            autocomplete="false"
            v-bind:class="{
      ...
      <p class="text--center">
        Not a member?
        <a href="#" @click="sign_up">Sign up now</a>
        <svg class="icon">
...
export default {
  ...
  methods: {
    async validate() {
      ...
      this.$forceUpdate();
      if (this.username_valid == true && this.password_valid == true){
        try {
